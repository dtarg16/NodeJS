...
const descriptionFileA = fs.createWriteStream(`${__dirname}/destination-text-a.txt`);
const descriptionFileB = fs.createWriteStream(`${__dirname}/destination-text-b.txt`);
